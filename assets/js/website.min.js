                    ...
                    function (e, c, u) {
                        ...
                        for (
                            ...
                            try {
                                angular.isString(o)
                                    ? e.has(o)
                                        ? ((r = e.get(o)), angular.isFunction(r) && (r = new r()))
                                        : console.warn('Service or Factory "', o, '" not found')
                                    : angular.isArray(o)
                                    ? (r = e.invoke(o))
                                    : angular.isFunction(o)
                                    ? (r = new o())
                                    : angular.isObject(o) && (r = o);
                            } catch (e) {
        ...
        function () {
            ...
            function o(e) {
                ...
                return !(
                    ...
                    ("part" === e.visibilityMode ? o < t || n < i : "full" === e.visibilityMode ? !(t <= i && o <= n) : (a && console.error("motoBeforeInViewport : unexpected visibilityMode", e.visibilityMode), 0))
                );
            }
            function c(e) {
                return (
                ...
                e
                    ...
                    : ((function () {
                          ...
                          for (e = 0; e < n.length; e++)
                              o(n[e])
                                  ? n[e].wasInViewport || (c(n[e]) && e--)
                                  : n[e].wasInViewport &&
                                    ((t = n[e]),
                                    a && console.log("motoBeforeInViewport: item leave frome viewport", t),
                                    t.element.removeClass("moto-after-in-viewport"),
                                    t.element.addClass("moto-before-in-viewport"),
                                    (t.wasInViewport = !1),
                                    angular.isString(t.onLeave) ? t.$scope.$eval(t.onLeave) : angular.isFunction(t.onLeave) && t.onLeave());
                      })(),
                      (t = !(e = !0)),
                      setTimeout(function () {
                          (e = !1), t && u();
    ...
    angular.module("website.core.humanize_duration").provider("motoHumanizeDuration", [
        function () {
            ...
            (this.humanize = function (e, t, n) {
                var i;
                return (
                    (!n || humanizeDuration.getSupportedLanguages().indexOf(n) < 0) && (n = "en"), r[t] && (t = r[t]), (i = humanizeDuration(e * o[t], { spacer: ">", language: n, units: [t], round: !0 })).substr(i.indexOf(">") + ">".length)
                );
            }),
                (this.$get = [
                    function () {
                ...
                (t.prototype.registry = function (e) {
                    ...
                    return (
                        ...
                        e instanceof i &&
                            ...
                            !this.isExists(e.id) && !!this._collection.push(e) && ((t = e.$element.attr("data-parent-id")), (n = this._collection.getById(t)) ? e.setParent(n) : o && e.setParent(o), (n = e.getParent()) && n.addChild(e), e)))
                    );
                }),
            ...
            return (
                ...
                (r.prototype.registerApiConnector = function (e, t) {
                    return !angular.isString(e) || e.trim().length < 1
                        ...
                        ? t.prototype instanceof o
                            ? ((e = e.trim()), (i[e] = { name: e, constructor: t }), !0)
...
angular.module("website").directive("motoBackgroundVideo", [
            ...
            (this.init = function () {
                ...
                (this.shouldPopupBeOpened = function (e, t, n) {
                    ...
                    return !(
                        "always" !== t &&
                        ("session" === t
                            ? (i = o.getLocalStorageItem("popups-session", {}))[e]
                            : ((i = o.getLocalStorageItem("popups-storage", {})), ("amount" === t && i[e] && i[e].shows >= n.shows) || ("overtime" === t && i[e] && Date.now() - i[e].timestamp < 1e3 * n.overtime)))
                    );
                });
        },
    ]),
    ...
    angular.module("website").directive("motoSticky", [
        ...
        function (e, o) {
            ...
            function h(e) {
                try {
                    "static" === (i = e).options.mode ||
                    ((c = (a = i.isAttached || i.options.hidden ? i.$pseudoElement : i.$element).get(0).getBoundingClientRect()),
                    (s = !1),
                    (l = i.options.offset),
                    (o = parseInt(a.css("marginTop")) || 0),
                    "smallHeight" === i.options.mode ? ((r = Math.max(document.documentElement.clientHeight, window.innerHeight || 0)), c.top + a.outerHeight() < r) : ("top" === i.options.direction && (s = c.top - o < l), s))
                        ? ((n = e).isAttached ||
                              (n.$element
                                  .show()
                        ...
                        : ((t = e).$pseudoElement.width(t.$element.innerWidth()),
                          t.isAttached &&
                              (t.$element.css("width", ""),
                              (t.isAttached = !1),
                              t.$element.removeClass(d.attachedClass).removeClass(d.attachedClass + "_" + t.options.direction),
                              t.options.hidden ? (t.$pseudoElement.height(0), t.$element.hide()) : t.$pseudoElement.hide(),
                              f(t.$element, "data-sticky-preset", "data-preset")));
                } catch (e) {
                    ...
                    setCurrentPageNumber: function (e) {
                        return (
                            ...
                            !isNaN(e) &&
                                ...
                                (this.previous = this.getPreviousPage() || new r(null, this.previousNumber)),
                                (this.current = this.getCurrentPage() || new r(null, this.currentNumber)),
                                (this.next = this.getNextPage() || new r(null, this.nextNumber)),
            ...
            return {
                ...
                link: function (e, t, n) {
                    var i,
                        ...
                        s =
                            ((i = a).itemsCount < 2 && (i.showPaginationDots = !1),
                            {
                                mode: "horizontal",
                                auto: !1,
                ...
                (n.validateEmailOnBlur = function () {
                    (n.contactForm.email.$pristine = !1),
                        "" !== n.contactForm.email.$viewValue
                            ? p.test(n.contactForm.email.$viewValue)
            ...
            return {
                ...
                compile: function (e, m) {
                    ...
                    for (i = 0; i < r.length; i++)
                        (n = (t = angular.element(r[i])).attr("data-ng-bind")), 0 === i && o.attr("max-time-unit", "'" + n.slice(0, -1) + "'"), 0 <= ["hours", "minutes", "seconds"].indexOf(n) && t.attr("data-ng-bind", n[0] + n);
                    return {
                        pre: function (e) {
                    ...
                    (n.submit = function () {
                        n.sending ||
                            ...
                            n.subscribeForm && n.subscribeForm.$valid && !n.subscribeForm.emailInvalid
                                ? ((r = "widget.MailChimp_" + new Date().getTime()), o.enable(r), (n.message.list_id = n.listId || ""), t.subscribe({ request: n.message }).success(p).error(g))
                                : (n.sending = !1));
                    });
            },
        ]),
                ...
                link: function (e, t, n) {
                    ...
                    (c.id = t.closest(".moto-widget-slider").attr("id")),
                        ...
                        d.$onLetsDanceEvent(l, function () {
                            (r = o.find(".bx-caption")).removeClass("bx-caption"),
                                r.css("display", "none"),
                                o.reloadSlider(angular.extend({}, i, { startSlide: o.getCurrentSlide() })),
                                r.addClass("bx-caption"),
                                r.css("display", ""),
                                d.isDisabledPlaying(t) || (c.slideshowEnabled && o.startAuto(), u(o.redrawSlider));
                        }),
            ...
            "object" != typeof l && (l = {}),
                (c = (function (e, t) {
                    ...
                    for (o = 0; o < e.length; o++)
                        (r[(n = (i = d(e[o])).attr("id") || i.attr("data-widget-id"))] = { id: n, $node: i, opened: i.hasClass(a), $wrapperNode: i.children(".moto-widget-accordion__content-wrapper") }),
            ...
            return {
                ...
                link: function (e, t, i, o) {
                    ...
                    e.$on("MotoForm::removeAttachedFile", function (e, t) {
                        ...
                        o.$modelValue === t && o.$setViewValue(void 0),
                            angular.isArray(i.$$ngfPrevValidFiles) && -1 < (n = i.$$ngfPrevValidFiles.indexOf(t)) && i.$$ngfPrevValidFiles.splice(n, 1),
                            angular.isArray(i.$$ngfPrevInvalidFiles) && -1 < (n = i.$$ngfPrevInvalidFiles.indexOf(t)) && i.$$ngfPrevInvalidFiles.splice(n, 1),
                            r();
                    }),
                        o.$parsers.push(r),
                        o.$parsers.push(l);
            ...
            return {
                ...
                link: function (e) {
                    ...
                    if ((angular.isFunction(e.$FORM.getValidationMessages) && (n = angular.copy(e.$FORM.getValidationMessages())), angular.isObject(n) && !angular.isArray(n)))
                        for (t in i) i.hasOwnProperty(t) && ((angular.isString(n[t]) && ((n[t] = n[t].trim()), 0 < n[t].length)) || (n[t] = i[t]));
    ...
    (jQuery.fn.motoCallback = function () {
        ...
        t.on("click", function () {
            ...
            i.on("click", function () {
                r.hasClass("moto-widget-callback__body_more-details-opened")
                    ? (o.slideUp(400), r.removeClass("moto-widget-callback__body_more-details-opened"))
                    : (o.slideDown(400), r.addClass("moto-widget-callback__body_more-details-opened"));
            });
    }),
    ...
    (function (c) {
        ...
        function m(e, t) {
            ...
            return (
                (n.id = e),
                (n.$root = t.find("#" + e)),
                (n.$desktopHeader = t.find(i + '[data-tab="' + e + '"]')),
                ...
                s.find(e).length &&
                    ...
                    s.on("click", t, function (e) {
                        ...
                        r !== l &&
                            ...
                            t.$desktopHeader.removeClass(u),
                            t.$mobileHeader.removeClass(u),
                            n && n(t),
                            (i = m((l = r), s)),
                            (o = a.onOpened),
                            i.$contentWrapper.show(),
                            i.$desktopHeader.addClass(u),
                            i.$mobileHeader.addClass(u),
                            (window.innerWidth || document.documentElement.clientWidth || document.body.clientWidth) < 1040 && c("html, body").animate({ scrollTop: i.$mobileHeader.offset().top }, 400),
                            o && o(i),
                            d.resize());
                    }));
        };
        ...
        h.fn.tileGallery = function () {
            ...
            function p() {
                var e,
                    ...
                    i,
                    o = h(a[0]);
                for (r.margins = parseInt(o.css("padding-bottom")), r.columns = [{ items: [o], heightWithPadding: o.innerHeight(), height: m(o) }], t = 1; t < a.length; t++)
                    (e = h(a[t])).position().left > o.position().left
                        ? ((i = e), r.columns.push({ items: [i], heightWithPadding: i.innerHeight(), height: m(i) }))
                        : ((n = e), r.columns[r.columns.length - 1].items.push(n), (r.columns[r.columns.length - 1].heightWithPadding += n.innerHeight()), (r.columns[r.columns.length - 1].height += m(n))),
                        (o = e);
            }
            function g(e) {
