	            ...
	            <div class="row row-lg">
					...
					<div class="col-lg-12 form-horizontal">
						<div class="form-group form-material">
							...
							<div class=" col-lg-12 col-sm-9">
								<input type="text" class="form-control" name="tag_line" placeholder="Service Tag Line" value="<?=$q['tag_line']?>">
							</div><!-- /12 -->
						</div><!-- /form-group -->
					</div><!-- /form-horizontal -->
					...
					<div class="col-lg-12 form-horizontal">
						<div class="form-group form-material">
							...
							<div class=" col-lg-12 col-sm-9">
								<input type="text" class="form-control" name="slug" placeholder="Service URL Slug" required="" value="<?=$q['slug']?>">
							</div><!-- /12 -->
						</div><!-- /form-group -->
					</div><!-- /form-horizontal -->
